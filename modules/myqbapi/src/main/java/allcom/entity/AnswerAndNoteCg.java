...
@Entity
@Table(name = "myqb_answerandnotecg",indexes = {@Index(name = "i_1",columnList = "umid",unique = false),@Index(name = "i_2",columnList = "questionId,subQuestionId",unique = true)})
public class AnswerAndNoteCg implements java.io.Serializable {
    ...
    protected AnswerAndNoteCg() {
    }

    public AnswerAndNoteCg(int umid, long questionId, int subQuestionId) {
        this.umid = umid;
